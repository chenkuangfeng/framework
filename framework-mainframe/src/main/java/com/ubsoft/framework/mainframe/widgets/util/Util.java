...
public class Util
{
    ...
    /**
     * 从目标数组中查找指定的元素
     * 由于Arrays.binarySearch只比较了==，对equals的仍然认为是不同，所以添加此方法
     * @param objs 目标数组
     * @param obj 指定元素
     * @return 指定元素的序号
     */
    public static int searchFromArray(Object[] objs, Object obj)
    {
        ...
        for(Object o: objs)
        {
            if((o == null && obj == null) || (o == obj) || (o != null && obj != null && o.equals(obj)))
            {
                pos = index;
                break;
            }
     ...
     * @param str 字符串
     * @param split 字节组中的分隔符
     * @param charsetName 字符集名称
     * @return 16进制字节组
     */
    public static String stringToHex(String str, String split, String charsetName)
    {
        byte[] bytes;
     ...
     */
    public static String stringToIntHex(String str)
    {
        StringBuilder hexes = new StringBuilder(str.length() * 2);
        String hex;
     ...
     */
    public static Object hexStringToObject(String str) throws IOException, ClassNotFoundException
    {
        Object obj = null;
        
        if(str != null)
        {
            byte byteArr[] = hexToBytes(str);
     ...
     */
    public static void writeFilesToSystemClipboard(final List<File> files)
    {
    ...
    public static boolean isChinese(char ch)
    {
        ...
        if(block == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS || block == Character.UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS
        || block == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A || block == Character.UnicodeBlock.GENERAL_PUNCTUATION
    ...
    /**
     * 将基本类型转化为对应的非基本类型
     * @param classes 可能含有基本类型的Class数组
